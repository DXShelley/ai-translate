(() => {
  ...
  const browserApi = {
    ...
    runtime: {
      ...
      get onMessage() {
        return runtimeApi?.runtime?.onMessage;
      },
      sendMessage(message) {
    ...
    storage: {
      get onChanged() {
        return runtimeApi?.storage?.onChanged;
      },
      sync: {
        get(keys) {
    ...
    get contextMenus() {
      return runtimeApi?.contextMenus;
    },
    get commands() {
      return runtimeApi?.commands;
    }
  };

  globalThis.litBrowser = browserApi;
})();